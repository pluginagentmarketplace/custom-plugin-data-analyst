...
This guide provides comprehensive documentation for the **business-intelligence** skill in the custom-plugin-data-analyst plugin.
...
```bash
# Invoke the skill
claude "business-intelligence - [your task description]"

# Example
claude "business-intelligence - analyze the current implementation"
```
...
def implement_business_intelligence(input_data):
    """
    Implement business-intelligence functionality.
