...
This guide provides comprehensive documentation for the **excel** skill in the custom-plugin-data-analyst plugin.
...
```bash
# Invoke the skill
claude "excel - [your task description]"

# Example
claude "excel - analyze the current implementation"
```
...
def implement_excel(input_data):
    """
    Implement excel functionality.
