...
This guide provides comprehensive documentation for the **data-cleaning** skill in the custom-plugin-data-analyst plugin.
...
```bash
# Invoke the skill
claude "data-cleaning - [your task description]"

# Example
claude "data-cleaning - analyze the current implementation"
```
...
def implement_data_cleaning(input_data):
    """
