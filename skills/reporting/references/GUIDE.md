...
This guide provides comprehensive documentation for the **reporting** skill in the custom-plugin-data-analyst plugin.
...
```bash
# Invoke the skill
claude "reporting - [your task description]"

# Example
claude "reporting - analyze the current implementation"
```
...
def implement_reporting(input_data):
    """
